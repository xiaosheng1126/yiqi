...
public class BaseViewHolderHelper extends RecyclerView.ViewHolder {
    ...
    public ImageDraweeView resize(@IdRes int resId, int width, int height){
        ImageDraweeView view = getView(resId);
        view.resize(width, height);
        return view;
    }

    public ImageDraweeView resizeTodp(@IdRes int resId, int width, int height){
        ImageDraweeView view = getView(resId);
        view.resizeTodp(width, height);
        return view;
    }

    public ImageDraweeView setImageDraweeView(@IdRes int resId,
                                              int width, int height, @NonNull String url){
        ImageDraweeView view = getView(resId);
        view.resizeTodp(width, height);
    ...
    public ImageDraweeView setImageURL(@IdRes int resId, @NonNull String url){
        ImageDraweeView view = getView(resId);
        view.setImageURL(url);
        return view;
    }
